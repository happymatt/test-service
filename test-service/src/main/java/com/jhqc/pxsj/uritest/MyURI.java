...
public final class MyURI
    implements Comparable<MyURI>, Serializable
{
     ...
     *          violates RFC&nbsp;2396
     */
    public MyURI(String scheme, String host, String path, String fragment)
        throws URISyntaxException
    {
     ...
     *          violates RFC&nbsp;2396
     */
    public MyURI(String scheme, String ssp, String fragment)
        throws URISyntaxException
    {
    ...
    public MyURI resolve(String str) {
        return resolve(MyURI.create(str));
    }
    ...
    // RFC2396 5.2
    private static MyURI resolve(MyURI base, MyURI child) {
        ...
        MyURI ru = new MyURI();             // Resolved URI
        ru.scheme = base.scheme;
    ...
    //
    private static MyURI normalize(MyURI u) {
    ...
    //
    private static MyURI relativize(MyURI base, MyURI child) {
        // check if child if opaque first so that NPE is thrown
        // if child is null.
        if (child.isOpaque() || base.isOpaque())
            return child;
